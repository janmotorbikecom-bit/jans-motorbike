...
async function run() {
  await testPayload('deleteKhachHang - admin - Quản trị', {
    fn: 'deleteKhachHang', secret: API_SECRET,
    args: ['TestUserDummy', '9999', { taiKhoan: 'admin', vaiTro: 'Quản trị' }]
  });
  await testPayload('deleteKhachHang - Chau Van - Quản trị viên', {
    fn: 'deleteKhachHang', secret: API_SECRET,
    args: ['TestUserDummy', '9999', { taiKhoan: 'Châu Vân', vaiTro: 'quản trị viên' }]
  });
}
run();
